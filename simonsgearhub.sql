...
-- 2. Rensa befintliga tabeller (i rätt ordning pga relationer)
...
-- 3. Skapa tabeller baserat på dina Java-entiteter
...
-- 4. Inserts för stamdata (5 per tabell)
INSERT INTO `members` (`first_name`, `last_name`, `email`) VALUES
('Kalle', 'Storm', 'kalle.storm@gmail.com'),
('Beata', 'Falk', 'beata.falk@yahoo.se'),
('Stefan', 'Lind', 'stefan.lind@outlook.com'),
('Sara', 'Björk', 'sara.bjork@me.com'),
('Erik', 'Dahl', 'erik.dahl@telia.com');
